-- stored procedure queryListarCreditoPorParametrizar
DELIMITER $$
...
DROP PROCEDURE queryListarCreditoPorParametrizar;
CALL queryListarCreditoPorParametrizar(?, ?);
CALL queryListarCreditoPorParametrizar('mapo1982', '');