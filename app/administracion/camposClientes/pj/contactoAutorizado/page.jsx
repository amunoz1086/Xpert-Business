...
export default async function ContactoAutorizado() {
    ...
    const dataCampos =(JSON.parse(await queryDataCampos()))?.DATA?.filter(e => e.TIPOCLI=='Pj'&&e.nombre=='Contacto Autorizado');  
                ...
                <div className={`border-2 w-full py-4 bg-white border-coomeva_color-grisPestaña2 rounded-lg`}>
                    <section className="flex flex-row">
                        <div className=" w-full px-2 py-1">
                            <ListadoCampos
                            tituloPagina="Contactos autorizados"  
                            nombrePrimerCol="Contacto autorizados"  
                                seccion={'secc1'}
                                formId={'form1'}
                                listSiNo={listSiNo}
                                ...
                                // tituloSaltoPagina={[{ id: 2000, numFila: 0, titulo: "" }]}
                            />
