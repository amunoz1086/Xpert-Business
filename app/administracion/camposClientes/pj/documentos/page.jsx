...
import { ListadoDocumentos } from "@/app/components/share/ListadoDocumentos";
...
export default async function Documentos() {
    ...
    const dataCampos = (JSON.parse(await queryDataCampos()))?.DATA?.filter(e => e.TIPOCLI == 'Pj' && e.nombre == 'Perfil');
