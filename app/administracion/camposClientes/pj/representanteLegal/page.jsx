...
export default async function PageRepresentanteLegal() {
    ...
    const dataCampos =(JSON.parse(await queryDataCampos()))?.DATA?.filter(e => e.TIPOCLI=='Pj'&&e.nombre=='Representante Legal');  
                    ...
                    <section className="flex flex-row">
                        <div className=" w-full px-2 py-1">
                            <ListadoCampos
                                ...
                                nombrePrimerCol="Representante Legal"
