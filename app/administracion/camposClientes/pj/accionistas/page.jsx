...
export default async function Accionistas() {
    ...
    const dataCampos =(JSON.parse(await queryDataCampos()))?.DATA?.filter(e => e.TIPOCLI=='Pj'&&e.nombre=='Accionistas'); 
                    ...
                    <section className="flex flex-row">
                        <div className=" w-full px-2 py-1">
                            <ListadoCampos
                                ...
                                tituloSaltoPagina={[{ id: 5900, numFila: 1, titulo: "SI LA CONSULTA ES PJ" },{ id: 5900, numFila: 9, titulo: "SI LA CONSULTA ES PN" }]}
                            />
