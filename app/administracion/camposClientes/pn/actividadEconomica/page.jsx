...
export default async function ActividadEconomica() {
    ...
    const dataCampos =(JSON.parse(await queryDataCampos())).DATA.filter(e => e.TIPOCLI=='PN'&&e.nombre=='Actividad Económica');  
            ...
            <div className={`border-2 w-full py-4 bg-white border-coomeva_color-grisPestaña2 rounded-lg`}>
                <section className="flex flex-row">
                    <div className=" w-full px-2 py-1">
                        <ListadoCampos
                            tituloPagina="Actividad económica"
                            nombrePrimerCol="Actividad económica"
