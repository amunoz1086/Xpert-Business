...
import LinkHomeAtrasAdministracion from "./LinkHomeAtrasAdministracion";


export default function InformacionMenuPrincipalAdministracion({ title, subtitle, paragraph, perfilActivo }) {
    return (
        <div id="contenedorSeccion" className="w-[100%] h-[40%] flex">
            <div id="informacionPricipal" className=" flex w-[100%] h-[100%] ">
                ...
                <div
                    ...
                    className="hidden md:w-[6%] lg:w-[15%] "
                >
                ...
                </div>
                {
                    paragraph ?
                        <div
                            id="parrafo"
                            className="hidden sm:block md:w-[70%] lg:w-[37%] "
                        >
            ...
            <LinkHomeAtrasAdministracion perfilActivo={perfilActivo} />
        </div>
    )
}