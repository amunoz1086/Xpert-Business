...
export const CampoNumeroParseoMilDecimal = ({ valorInput = '', placeholder = 'Numero mil decimales', nameInput = 'name', requerido = false, estado = false,nDecimales=2, onChangeInput = () => { }, onBlurInput = () => { } }) => {
                ...
                <input
                    ...
                    onBlur={(e) => {
                       ...
                       //validarCompoRequerido({ e, setMostrar, setPlaceholderInput, placeholder, requerido })
                        ...
                        e.target.value = e.target.value.length>0? (conversionPesos({ valor:e.target.value,nDecimales:nDecimales })).replace(/[^\d.,]/g, ''):''
