...
import {  separarMiles, validarCompoRequerido } from "@/app/lib/utils"
import { useState } from "react"

export const CampoNumeroParseoMil = ({ valorInput = '', nameInput = 'name',placeholder, validacionRequeridoEditable, onChangeInput = () => { }, onBlurInput = () => { } }) => {
                    ...
                    <input
                        ...
                        onChange={
                            (e) => {
                                ...
                                e.target.value = e.target.value.length > 0 ? separarMiles({ valor: e.target.value }) : ''
