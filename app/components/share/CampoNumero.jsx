...
export const CampoNumero = ({ valorInput = '', fonntSeze = 'text-lg', placeholder = 'Numero', nameInput = 'name', validacionRequeridoEditable, onChangeInput = () => { }, onBlurInput = () => { } }) => {
            ...
            <div>
                ...
                <div className='flex justify-center items-center gap-2'>
                    ...
                    <input
                        ...
                        id={nameInput}
                        name={nameInput}
                        className={`focus:outline-none bg-transparent ${fonntSeze}  text-gray-700  flex item-start w-full bg-red`}
                        autoComplete='off'
