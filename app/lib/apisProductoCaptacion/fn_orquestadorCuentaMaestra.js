...
export const fn_orquestadorCuentaMaestra = async (data) => {
  ...
  try {
    ...
    const dataReques = {
      ...
      "externalReference": rawRolesAsignados[0].phoneNumero, //Celular
      "accountName": rawRolesAsignados[0].nombreCliente, //Nombre de la Cuenta
      "serviceTypeCode": rawOperacion.tipoServicio, //Tipo Servicio
      "legalAgreementReference": rawOperacion.numeroContrato, //Numero de Contrato   
      "accountStatus": null,
