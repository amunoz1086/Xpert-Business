...
export const notificacionRadicacion = async (req) => {
    ...
    console.log('Notificacion Radicador:', dataCorreo.CORREO);

    const message = {
        from: "noreplyqa@coomeva.com.co",
        to: `${dataCorreo.CORREO}`,
        ...
        <body
            ...
            <main style="height: auto; width: 95%; margin: 0% auto;">
                <table style="width: 95%; border-collapse: collapse;">
                    ...
                    <tr>
                        <td>
                            Cordial Saludo, la solicitud <strong>Nº ${dataCorreo.COD_SOLICITUD}</strong> de la regional <strong>${dataCorreo.REGIONAL}</strong>, correspondiente a la operación de
                            <strong>${dataCorreo.CREDITO === '01' ? 'Credito' : ''}, ${dataCorreo.CONVENIO === '03' ? 'Convenio' : ''}
                            ${dataCorreo.OPERACION !== '1' ? 'Ajuste' : 'Nuevo'}</strong>, fue aprobada por los diferentes entes asignados.
                            Proceda a generar el contrato y a cargar los documentos necesarios para que el paramertrizador analice
                            y finalice la solicitud.  
                            <br>
                            <br>
                            <br>
                            <br>
                        ...
                        <td style="width: 20%;">
                            <table border="1" style="width: 100%; border-collapse: collapse; font-size: 14px;">
                                ...
                                <tr>
                                    ...
                                    <td>${dataCorreo.CORRIENTETASA === null ? 0.00 : dataCorreo.CORRIENTETASA === '' ? 0.00 : parseFloat(dataCorreo.CORRIENTETASA).toFixed(2).toLocaleString()} %</td>
                                </tr>
                                <tr>
