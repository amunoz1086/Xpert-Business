/* MP: webservices consultar produtos PJ con targetas 1.0, solicita numeroDocumento*/

async function fn_xmlPath_consultarProductosPj_conTarjeta(dataConsultarProductosPj) {
   ...
   dataReques.pridXml = 'consulta_productosPj_conTarjetas';
...
module.exports = {
   "fn_xmlPath_consultarProductosPj_conTarjeta": fn_xmlPath_consultarProductosPj_conTarjeta,
}