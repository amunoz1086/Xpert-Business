/* MP: función para insertar(insert) nuevos items desde el complemento GastosDirectosOficina */

import { pool } from '../../../../../../config/conectPRICINGDB';

export default async function insertGastosDirectosOficina(req, res,) {
