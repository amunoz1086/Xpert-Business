/* MP: función para eliminar(delete) los registros seleccionados desde el componente GastosDirectosPSE */

import { pool } from '../../../../../../config/conectPRICINGDB';

export default async function deleteGastosDirectosPse(req, res,) {
