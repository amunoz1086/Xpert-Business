/* MP: función para la consulta de los diferentes items utilizados en el componente GastosDirectosOficina */

import { pool } from '../../../../../../config/conectPRICINGDB';

export default async function queryGastosDirectosOficina(req, res,) {
