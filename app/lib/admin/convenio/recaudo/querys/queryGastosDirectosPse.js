/* MP: función para la consulta de los diferentes items utilizados en el componente GastosDirectosPSE */

import { pool } from '../../../../../../config/conectPRICINGDB';

export default async function queryGastosDirectosPse(req, res,) {
