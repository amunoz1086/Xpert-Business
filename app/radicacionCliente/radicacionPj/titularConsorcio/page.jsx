...
import { TitularConsorcio } from "@/app/components/radicacionCliente/pj/TitularConsorcio";

// Deshabilita ISR en desarrollo; en prod puedes ajustar a RRULE o segundos de cache.
export const revalidate = 0;

export default async function FuntaDirectivaPj() {
                    ...
                    <section className="flex flex-row">
                        <div className="w-full px-8 py-1">
                            <div className="p-4 min-h-screen">
                                <TitularConsorcio contextRadClient={contextRadClient}
