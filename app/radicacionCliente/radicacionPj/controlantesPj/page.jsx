// app/radicacionCliente/pj/controlantesPj/page.jsx
...
import { ControlantesPj } from "@/app/components/radicacionCliente/pj/ControlantesPj";
...
export default async function PageControlantesPj() {
    ...
    const dataCampos = camposValidar?.filter(
        (e) => e.TIPOCLI === "Pj" && e.nombre === "Controlantes"
    );


    // batch‐fetch all your lists
    const lists = await fetchLists({
        listTipoControlante: queryTipoJuntaDirectiva,
