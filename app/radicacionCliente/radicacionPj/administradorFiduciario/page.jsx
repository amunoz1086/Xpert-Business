...
import { AdministradorFiduciario } from "@/app/components/radicacionCliente/pj/AdministradorFiduciario";
                    ...
                    <section className="flex flex-row">
                        <div className="w-full px-8 py-1">
                            <div className="p-4 min-h-screen">
                                <AdministradorFiduciario contextRadClient={contextRadClient}
