self.onmessage = async function (e) {
    ...
    try {
        ...
        //Administrador Consorcios
        if (rawCustomerReferences.administradorConsorcio.length > 0) {
            let contRepre = 0;
            for (let i of rawCustomerReferences.administradorConsorcio) {
                ...
                if (+parsedStatus.status === 200) {
                    ...
                    validDetallesParticipantes.adminConsorcios.push(JSON.parse(json.resultados));
