self.onmessage = async function (e) {
    ...
    try {
        ...
        //Accionista
        if (rawCustomerReferences.accionista.length > 0) {
            let contRepre = 0;
            for (let i of rawCustomerReferences.accionista) {
                ...
                if (+parsedStatus.status === 200) {
                    ...
                    validDetallesParticipantes.accionista.push(JSON.parse(json.resultados));
                ...
                if (contRepre === rawCustomerReferences.accionista.length) {
                    break;
                };
            };
        };
