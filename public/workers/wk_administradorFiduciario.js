self.onmessage = async function (e) {
    ...
    try {
        ...
        if (rawCustomerReferences.administradorFiduciario.length > 0) {
            let contRepre = 0;
            for (let i of rawCustomerReferences.administradorFiduciario) {
                ...
                if (+parsedStatus.status === 200) {
                    ...
                    validDetallesParticipantes.admFiduciario.push(JSON.parse(json.resultados));
                ...
                if (contRepre === rawCustomerReferences.administradorFiduciario.length) {
                    break;
                };
            };
        };
