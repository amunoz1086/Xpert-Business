self.onmessage = async function (e) {
    ...
    try {
        ...
        //controlante
        if (rawCustomerReferences.controlante.length > 0) {
            let contRepre = 0;
            for (let i of rawCustomerReferences.controlante) {
                ...
                if (+parsedStatus.status === 200) {
                    ...
                    validDetallesParticipantes.controlante.push(JSON.parse(json.resultados));
                ...
                if (contRepre === rawCustomerReferences.controlante.length) {
                    break;
                };
            };
        };
