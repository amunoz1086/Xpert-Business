self.onmessage = async function (e) {
    ...
    try {
        ...
        //Titular Consorcio
        if (rawCustomerReferences.titularConsorcio.length > 0) {
            let contRepre = 0;
            for (let i of rawCustomerReferences.titularConsorcio) {
                ...
                if (+parsedStatus.status === 200) {
                    ...
                    validDetallesParticipantes.titularConsorcio.push(JSON.parse(json.resultados));
                ...
                if (contRepre === rawCustomerReferences.titularConsorcio.length) {
                    break;
                };
            };
        };
